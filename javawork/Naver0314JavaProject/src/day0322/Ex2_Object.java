...
class Orange {
	...
	public String getName() {
		// return this.name; // this: 자기자신을 의미하는 인스턴스 변수 (일반 멤버 메소드에서만 존재, static 메소드에는 없음)
		return name; // 같은 구억 안에 같은 이름이 없을 경우에만 this 생략 가능
	}
	
	public int getAge() {
		return this.age; // this 는 생략 가능
	}
	
	// setter 메소드: 외부로부터 값을 받아서 멤버변수의 값을 변경
...
public class Ex2_Object {
	...
	public static void main(String[] args) {
		...
		// static method 호출도 클래스명으로 호출 가능
