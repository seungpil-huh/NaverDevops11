...
<!-- admin 이 아닌 계정으로 로그인을 했거나 로그인 상태가 아닐 경우 보여질 메세지 -->
...
<table class="table table-striped" style="width: 500px;">
	...
	<c:forEach var="dto" items="${list}" varStatus="i">
		<tr>
			...
			<td>
				<img src="../save/${dto.photo}" class="rounded-circle" style="width: 40px;height: 40px;" onerror="this.src='../image/noimage1.png'">
				${dto.name}
			</td>
			<td>${dto.myid}</td>
			<td>${dto.hp}</td>
