...
<table class="table" style="width:500px; margin:20px;">
	...
	<tr>
		<td width="200">
			...
			<button type="button" class="btn btn-sm btn-success" onclick="$('#photoupload').trigger('click')">사진 수정</button>
		</td>
		<td>
			아이디: ${dto.myid}<br>
			핸드폰: ${dto.hp}<br>
	...
	<tr>
		<td colspan="2" align="center">
			...
			<button type="button" class="btn btn-sm btn-outline-secondary" style="width:80px;" onclick="">삭제</button>
		</td>
	</tr>
</table>
</body>
